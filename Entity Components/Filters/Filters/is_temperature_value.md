...
<td>(Required) The Biome temperature value to compare with.
</td></tr></tbody></table></dd></dl>
...
```  
[翻訳元](https://minecraft.gamepedia.com/Bedrock_Edition_entity_components_documentation#is_temperature_value)  
