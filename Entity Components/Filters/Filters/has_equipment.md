...
<td>(Optional) The equipment location to test
<dl><dd><table class="wikitable">
<tbody><tr>
<th>Options</th>
<th>説明
...
<td>(Required) The item name to look for
</td></tr></tbody></table></dd></dl>
...
```  
[翻訳元](https://minecraft.gamepedia.com/Bedrock_Edition_entity_components_documentation#has_equipment)  
