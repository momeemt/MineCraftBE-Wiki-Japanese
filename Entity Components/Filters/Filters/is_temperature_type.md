...
<td>(Required) The Biome temperature catagory to test
<dl><dd><table class="wikitable">
<tbody><tr>
<th>Options</th>
<th>説明
...
```  
[翻訳元](https://minecraft.gamepedia.com/Bedrock_Edition_entity_components_documentation#is_temperature_type)  
